...
export const pythonTest: CourseTest = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: 'String slicing [1:4] starts at index 1 (y) and goes up to but not including index 4, giving "yth"',
      difficulty: 'Easy'
    },
    {
      id: 'py-12',
      ...
      correctAnswer: 3,
      explanation: 'Tuples are immutable and cannot be modified after creation. This is their key difference from lists',
      difficulty: 'Easy'
    },
    {
      id: 'py-13',
    ...
    {
      id: 'py-14',
      question: 'What will be the value of x after: x = [1, 2, 3]; y = x; y.append(4)?',
      options: ['[1, 2, 3]', '[1, 2, 3, 4]', 'Error', 'None'],
      correctAnswer: 1,
      explanation: 'Lists are mutable and y = x creates a reference (not a copy), so modifying y also changes x',
      difficulty: 'Medium'
    },
    {
      id: 'py-15',
      question: 'Which comprehension creates a dictionary mapping numbers to their squares?',
      options: [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: 'zip() takes multiple iterables and combines them element by element into tuples',
      difficulty: 'Medium'
    },
    {
      id: 'py-18',
      question: 'What is the output of: bool(""), bool([]), bool(0)?',
      options: [
        'True, True, True',
        'False, False, False',
        'True, False, False',
      ...
      correctAnswer: 1,
      explanation: 'Empty strings, empty lists, and zero all evaluate to False in Python',
      difficulty: 'Easy'
    },
    {
      id: 'py-19',
      ...
      correctAnswer: 1,
      explanation: 'Sets use the add() method to insert new elements. append() is for lists',
      difficulty: 'Easy'
    },
    {
      id: 'py-20',
      ...
      correctAnswer: 1,
      explanation: 'Lambda functions are anonymous, inline functions defined with the lambda keyword',
      difficulty: 'Medium'
    },
    {
      id: 'py-21',
      ...
      correctAnswer: 1,
      explanation: '**kwargs collects any number of keyword arguments into a dictionary',
      difficulty: 'Medium'
    },
    {
      id: 'py-22',
    ...
    },
    {
      ...
      options: [
        'Creates a loop',
        'Defines a function',
        'Ensures proper resource management (context manager)',
        'Imports modules'
      ],
      correctAnswer: 2,
      explanation: 'The "with" statement ensures proper acquisition and release of resources, like automatically closing files',
      difficulty: 'Hard'
    },
    {
      id: 'py-24',
    ...
    {
      id: 'py-25',
      question: 'What does list.extend([1,2]) do compared to list.append([1,2])?',
      options: [
        'They are identical',
        'extend adds elements individually, append adds as single item',
        'append adds elements individually, extend adds as single item',
        'extend is faster'
      ],
      correctAnswer: 1,
      explanation: 'extend() adds each element from the iterable, while append() adds the entire iterable as one element',
      difficulty: 'Medium'
    }
  ]
}
